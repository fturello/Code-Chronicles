        ...
        <div className={styles["welcome-container"]}>
            <div className={styles.welcome}>
                <div className={styles["quit-container"]}>
                    <button onClick={() => setRegistration(false)} className={styles.quit}>
                        <span className={styles.spanQuit}>Back</span>
                    </button>
                </div>
                <h1 className={styles["welcome-h1"]}>Super !</h1>
                <p className={styles["welcome-p"]}>Nous sommes pressé.e.s de vous voir participer à cette aventure !</p>
